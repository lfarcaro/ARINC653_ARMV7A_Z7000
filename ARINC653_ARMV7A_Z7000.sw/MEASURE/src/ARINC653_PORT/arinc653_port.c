...
/*LDR PC, [PC, #0x10]*/(portUINTBASE) 0xE59FF010,
/*Reset handler*/(portUINTBASE) PORT_RESETHANDLER_CORE0,
...
// Core #1 vector table
portUINTBASE PORT_VECTORTABLE_CORE1[PORT_VECTORTABLE_SIZE] = {
/*LDR PC, [PC, #0x18]*/(portUINTBASE) 0xE59FF018,
/*LDR PC, [PC, #0x18]*/(portUINTBASE) 0xE59FF018,
/*LDR PC, [PC, #0x18]*/(portUINTBASE) 0xE59FF018,
/*LDR PC, [PC, #0x18]*/(portUINTBASE) 0xE59FF018,
...
/*LDR PC, [PC, #0x10]*/(portUINTBASE) 0xE59FF010,
/*LDR PC, [PC, #0x10]*/(portUINTBASE) 0xE59FF010,
/*Reset handler*/(portUINTBASE) PORT_RESETHANDLER_CORE1,
/*Undefined instruction handler*/(portUINTBASE) PORT_UNDEFINEDINSTRUCTIONHANDLER,
/*SVC handler*/(portUINTBASE) PORT_SVCHANDLER,
/*Abort handler*/(portUINTBASE) PORT_ABORTHANDLER,
/*IRQ handler*/(portUINTBASE) PORT_IRQHANDLER,
...
// Release cores flag
portUINTBASE PORT_RELEASECORES = 0;
...
static portBOOLEAN PORT_PREPAREGLOBALFLTRANSLATIONTABLE(portUINTBASE **PTR_FLTRANSLATIONTABLE) {
	...
	// Sets access
	UINT_ACCESS = MMU_ACCESS_PL1_RW_PL0_RW;

	// Verifies access
	if (UINT_ACCESS != null) {

		// Maps FPGA0 region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) 0x40000000, (portUINTBASE) 0x80000000, MMU_MEMORYTYPE_STRONGLYORDERED_SHAREABLE, MMU_CACHEPOLICY_NONCACHEABLE, MMU_CACHEPOLICY_NONCACHEABLE, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_GLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		// Maps FPGA1 region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) 0x80000000, (portUINTBASE) 0xC0000000, MMU_MEMORYTYPE_STRONGLYORDERED_SHAREABLE, MMU_CACHEPOLICY_NONCACHEABLE, MMU_CACHEPOLICY_NONCACHEABLE, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_GLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		// Maps PS Peripherals region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) 0xE0000000, (portUINTBASE) 0xE0300000, MMU_MEMORYTYPE_DEVICE_SHAREABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_NONCACHEABLE, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_GLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		// Maps PS NAND region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) 0xE1000000, (portUINTBASE) 0xE2000000, MMU_MEMORYTYPE_DEVICE_SHAREABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_NONCACHEABLE, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_GLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		// Maps PS NOR region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) 0xE2000000, (portUINTBASE) 0xE4000000, MMU_MEMORYTYPE_DEVICE_SHAREABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_NONCACHEABLE, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_GLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		// Maps PS SRAM region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) 0xE4000000, (portUINTBASE) 0xE6000000, MMU_MEMORYTYPE_NORMAL_WB_NOWA, MMU_CACHEPOLICY_WB_NOWA, MMU_CACHEPOLICY_NONCACHEABLE, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_GLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		// Maps PS AMBA APB region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) 0xF8000000, (portUINTBASE) 0xF9000000, MMU_MEMORYTYPE_DEVICE_SHAREABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_NONCACHEABLE, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_GLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		// Maps PS QSPI region
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) 0xFC000000, (portUINTBASE) 0xFE000000, MMU_MEMORYTYPE_NORMAL_WT_NOWA, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_NONCACHEABLE, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_GLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
...
static portBOOLEAN PORT_PREPARENONGLOBALFLTRANSLATIONTABLE(portUINTBASE **PTR_FLTRANSLATIONTABLE, portUINTBASE UINT_CONTEXT, PARTITION_INFORMATION_TYPE *CONTEXT_PARTITION_INFORMATION, PROCESS_INFORMATION_TYPE *CONTEXT_PROCESS_INFORMATION) {
	...
	if (UINT_ACCESS != null) {
		...
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) PORT_MODULE_CONFIGURATION->VECTORTABLE_ADDRESS, (portUINTBASE) ((portUINTBASE) PORT_MODULE_CONFIGURATION->VECTORTABLE_ADDRESS + PORT_MODULE_CONFIGURATION->VECTORTABLE_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) MODULE_CONFIGURATION->MODULE_STACK_ADDRESS, (portUINTBASE) ((portUINTBASE) MODULE_CONFIGURATION->MODULE_STACK_ADDRESS + MODULE_CONFIGURATION->MODULE_STACK_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) MODULE_CONFIGURATION->MODULE_HEAP_ADDRESS, (portUINTBASE) ((portUINTBASE) MODULE_CONFIGURATION->MODULE_HEAP_ADDRESS + MODULE_CONFIGURATION->MODULE_HEAP_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (UINT_ACCESS != null) {
		...
		if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) PORT_MODULE_CONFIGURATION->MODULE_FLTRANSLATIONTABLE_ADDRESS, (portUINTBASE) ((portUINTBASE) PORT_MODULE_CONFIGURATION->MODULE_FLTRANSLATIONTABLE_ADDRESS + PORT_MODULE_CONFIGURATION->MODULE_FLTRANSLATIONTABLE_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WT_NOWA, MMU_CACHEPOLICY_WT_NOWA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
			return false;
		}
	}
	...
	if (MODULE_CONFIGURATION->MODULE_HMCALLBACK_STACK_ADDRESS != null) {
		...
		if (UINT_ACCESS != null) {
			...
			if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) MODULE_CONFIGURATION->MODULE_HMCALLBACK_STACK_ADDRESS, (portUINTBASE) ((portUINTBASE) MODULE_CONFIGURATION->MODULE_HMCALLBACK_STACK_ADDRESS + MODULE_CONFIGURATION->MODULE_HMCALLBACK_STACK_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
				return false;
			}
		}
	}
	...
	for (PARTITIONINDEX = 0; PARTITIONINDEX < MODULE_CONFIGURATION->PARTITION_CONFIGURATION_SIZE; PARTITIONINDEX++) {
		...
		if (UINT_ACCESS != null) {
			...
			if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) PARTITION_CONFIGURATION->PARTITION_DATA_IMAGE_ADDRESS, (portUINTBASE) ((portUINTBASE) PARTITION_CONFIGURATION->PARTITION_DATA_IMAGE_ADDRESS + PARTITION_CONFIGURATION->PARTITION_DATA_IMAGE_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
				return false;
			}
		}
		...
		if (UINT_ACCESS != null) {
			...
			if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) PARTITION_CONFIGURATION->PARTITION_DEFAULTPROCESS_STACK_ADDRESS, (portUINTBASE) ((portUINTBASE) PARTITION_CONFIGURATION->PARTITION_DEFAULTPROCESS_STACK_ADDRESS + PARTITION_CONFIGURATION->PARTITION_DEFAULTPROCESS_STACK_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
				return false;
			}
		}
		...
		if (PARTITION_CONFIGURATION->PARTITION_HMCALLBACK_STACK_ADDRESS != null) {
			...
			if (UINT_ACCESS != null) {
				...
				if (!MMU_MAPREGION(*PTR_FLTRANSLATIONTABLE, (portUINTBASE) PARTITION_CONFIGURATION->PARTITION_HMCALLBACK_STACK_ADDRESS, (portUINTBASE) ((portUINTBASE) PARTITION_CONFIGURATION->PARTITION_HMCALLBACK_STACK_ADDRESS + PARTITION_CONFIGURATION->PARTITION_HMCALLBACK_STACK_SIZE), MMU_MEMORYTYPE_NORMAL_CACHEABLE, MMU_CACHEPOLICY_WB_WA, MMU_CACHEPOLICY_WB_WA, MMU_SHAREABILITY_NONSHAREABLE, MMU_SECURITY_SECURE, MMU_SCOPE_NONGLOBAL, UINT_ACCESS)) {
					return false;
				}
			}
		}
...
portBOOLEAN PORT_HOOK_STARTUP_SYSTEM(void) {
	portUINTBASE CONSOLEINSTANCE;

	// Initializes modules' configurations
	CORE_MODULE_INFORMATION[0].MODULE_CONFIGURATION = MODULE_CONFIGURATION_CORE0;
	CORE_MODULE_INFORMATION[1].MODULE_CONFIGURATION = MODULE_CONFIGURATION_CORE1;

	// Initializes console instances
	for (CONSOLEINSTANCE = 0; CONSOLEINSTANCE < CONSOLE_INSTANCECOUNT; CONSOLEINSTANCE++) {
		if (!CONSOLE_STARTUP(CONSOLEINSTANCE)) {
			return false;
		}
	}

	// Starts tick timer
	if (!TIMER_TICK_STARTUP()) {
		return false;
	}
...
portBOOLEAN PORT_HOOK_BEFORE_STARTUP_MODULE(void) {
	...
	switch (CP15CoreIDGet()) {
	case 0:
		VECTORTABLESOURCE = (portUINTBASE *) PORT_VECTORTABLE_CORE0;
		VECTORTABLEDESTINATION = (portUINTBASE *) PORT_VECTORTABLE_ADDRESS_CORE0;
		break;
	case 1:
		VECTORTABLESOURCE = (portUINTBASE *) PORT_VECTORTABLE_CORE1;
		VECTORTABLEDESTINATION = (portUINTBASE *) PORT_VECTORTABLE_ADDRESS_CORE1;
		break;
	default:
		return false;
	}
	...
	case 0:
		...
		break;
	case 1:
		CP15VectorBaseAddrSet(PORT_VECTORTABLE_ADDRESS_CORE1);
		break;
	default:
		return false;
	}
	...
	if (!INTERRUPT_STARTUP()) {
		return false;
	}

	// Starts up PMU module
	PMU_STARTUP();
...
portBOOLEAN PORT_HOOK_AFTER_STARTUP_MODULE(void) {
	...
	// Enables MMU
	MMU_ENABLE(((PORT_CONTEXT_TYPE *) MODULE_INFORMATION->CONTEXT.PORT_CONTEXT)->FLTRANSLATIONTABLE_ADDRESS, PORT_MODULE_CONFIGURATION->MODULE_GLOBAL_FLTRANSLATIONTABLE_ADDRESS, ((PORT_CONTEXT_TYPE *) MODULE_INFORMATION->CONTEXT.PORT_CONTEXT)->CONTEXT_IDENTIFIER);
...
void PORT_GETCONTEXTIDENTIFIERRANGE(IDENTIFIER_TYPE *FIRST_CONTEXT_IDENTIFIER, IDENTIFIER_TYPE *LAST_CONTEXT_IDENTIFIER) {
	...
	// Verifies core identifier
	switch (CP15CoreIDGet()) {
	case 0:
		*FIRST_CONTEXT_IDENTIFIER = 1;
		*LAST_CONTEXT_IDENTIFIER = 127;
		break;
	case 1:
		*FIRST_CONTEXT_IDENTIFIER = 128;
...
void PORT_RESTARTMODULE(void) {
	...
	// Resets the platform
	*((portUINTBASE *)0xF8000008) = 0xDF0D; // SLCR_UNLOCK = 0xDF0D; (Unlock SLCR)
	*((portUINTBASE *)0xF8000200) = 0x1; // PSS_RST_CTRL = 0x1; (Soft reset)
}
...
static void PORT_ABORTERRORHANDLER_GETFAULTSTATUS(portUINTBASE FS, BOOLEAN_TYPE IN_STACK_AREA, ERROR_IDENTIFIER_TYPE *ERROR_IDENTIFIER, ERROR_CODE_TYPE *ERROR_CODE, MESSAGE_ADDR_TYPE *MESSAGE_ADDR, MESSAGE_SIZE_TYPE *MESSAGE_SIZE) {
	...
	case 15: //0b01111 - Permission fault, second level
		...
		*MESSAGE_SIZE = (IN_STACK_AREA ? 14 : 16);
		...
		if (IN_STACK_AREA) {
			CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Stack overflow (%u)", FS);
		} else {
			CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Memory violation (%u)", FS);
		}
#endif
		break;
	case 26: //0b11010 - Coprocessor abort
		...
		*MESSAGE_SIZE = 14;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Hardware fault (%u)", FS);
#endif
		break;
	...
	case 20: //0b10100 - Lockdown
		...
		*MESSAGE_SIZE = 17;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Translation fault (%u)", FS);
#endif
		break;
	case 1: //0b00001 - Alignment fault
		...
		*MESSAGE_SIZE = 22;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Memory alignment fault (%u)", FS);
#endif
		break;
	...
	case 30: //0b11110 - Synchronous parity error on translation table walk, second level
		...
		*MESSAGE_SIZE = 19;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Memory access fault (%u)", FS);
#endif
		break;
	case 4: //0b00100 - Fault on instruction cache maintenance
		...
		*MESSAGE_SIZE = 11;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Cache fault (%u)", FS);
#endif
		break;
	default:
		...
		*MESSAGE_SIZE = 0;
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "WARNING: Unhandled error (%u)", FS);
#endif
		break;
	}
}
...
void PORT_ABORTERRORHANDLER(portUINTBASE DFAR, portUINTBASE DFSR, portUINTBASE IFAR, portUINTBASE IFSR, portUINTBASE LR) {
	...
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Current context (%u): ", CURRENT_CONTEXT->IDENTIFIER);

	// Verifies current system state
	switch (CURRENT_CONTEXT->SYSTEM_STATE) {
	case SYSTEMSTATE_MODULEHEALTHMONITORINGCALLBACK:
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Module HM callback\n");
		break;
	case SYSTEMSTATE_MODULEDEFAULTPARTITION:
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Module default partition\n");
		break;
	case SYSTEMSTATE_MODULEIDLEPARTITION:
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Module idle partition\n");
		break;
	case SYSTEMSTATE_PARTITIONHEALTHMONITORINGCALLBACK:
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Partition HM callback\n");
		break;
	case SYSTEMSTATE_PARTITIONERRORHANDLER:
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Partition error handler\n");
		break;
	case SYSTEMSTATE_PARTITIONDEFAULTPROCESS:
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Partition default process\n");
		break;
	case SYSTEMSTATE_PARTITIONIDLEPROCESS:
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Partition idle process\n");
		break;
	case SYSTEMSTATE_PROCESS:
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Process\n");
		break;
	case SYSTEMSTATE_OPERATINGSYSTEM:
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Operating system\n");
		break;
	}
	...
	if (NEXT_CONTEXT != null) {
		...
		// Shows next context
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Next context (%u): ", NEXT_CONTEXT->IDENTIFIER);
...
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		// Shows abort type
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Prefetch abort: ");
#endif
...
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		// Breaks line
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "\n");
#endif
	...
	if (DFSR != null) {
...
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
		// Shows abort type
		CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Data abort: ");
#endif
		...
		if (WnR) {
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
			CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, " while writing 0x%X, running at 0x%X\n", DFAR, LR);
#endif
		} else {
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
			CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, " while reading 0x%X, running at 0x%X\n", DFAR, LR);
#endif
		}
...
#if PORT_GENERATECONSOLEOUTPUT_ERRORS == true
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Undefined instruction (0x%X)\n", LR);
#endif
}
...
void PORT_REPORTSYSTEMERROR(SYSTEM_STATE_TYPE SYSTEM_STATE, ERROR_IDENTIFIER_TYPE ERROR_IDENTIFIER, ERROR_CODE_TYPE ERROR_CODE, MESSAGE_ADDR_TYPE MESSAGE_ADDR, ERROR_MESSAGE_SIZE_TYPE LENGTH) {
	...
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "System error: ");
	CONSOLE_PUTS(CONSOLE_DEFAULTINSTANCE, (char *) MESSAGE_ADDR, (int) LENGTH);
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, ", system state %u, error identifier %u, error code %u\n", SYSTEM_STATE, ERROR_IDENTIFIER, ERROR_CODE);
#endif
}
...
#if PORT_GENERATECONSOLEOUTPUT_REPORTS == true
	// Prints to UART console
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Module error: ");
	CONSOLE_PUTS(CONSOLE_DEFAULTINSTANCE, (char *) MESSAGE_ADDR, (int) LENGTH);
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, ", system state %u, error identifier %u, error code %u\n", SYSTEM_STATE, ERROR_IDENTIFIER, ERROR_CODE);
#endif
}
...
#if PORT_GENERATECONSOLEOUTPUT_REPORTS == true
	// Prints to UART console
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Partition error: ");
	CONSOLE_PUTS(CONSOLE_DEFAULTINSTANCE, (char *) MESSAGE_ADDR, (int) LENGTH);
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, ", system state %u, error identifier %u, error code %u\n", SYSTEM_STATE, ERROR_IDENTIFIER, ERROR_CODE);
#endif
}
...
#if PORT_GENERATECONSOLEOUTPUT_REPORTS == true
	// Prints to UART console
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Process error: ");
	CONSOLE_PUTS(CONSOLE_DEFAULTINSTANCE, (char *) MESSAGE_ADDR, (int) LENGTH);
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, ", system state %u, error identifier %u, error code %u, failed process %u, failed address 0x%X\n", SYSTEM_STATE, ERROR_IDENTIFIER, ERROR_CODE, FAILED_PROCESS_ID, FAILED_ADDRESS);
#endif
}
...
#if PORT_GENERATECONSOLEOUTPUT_REPORTS == true
	// Prints to UART console
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "Application message: ");
	CONSOLE_PUTS(CONSOLE_DEFAULTINSTANCE, (char *) MESSAGE_ADDR, (int) LENGTH);
	CONSOLE_PRINTF(CONSOLE_DEFAULTINSTANCE, "\n");
#endif
}
