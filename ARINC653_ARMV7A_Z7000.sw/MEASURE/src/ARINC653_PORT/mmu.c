...
unsigned char MMU_FLTRANSLATIONTABLE_ALLOCATE(unsigned int **PTR_FLTRANSLATIONTABLE) {
	...
	MMU_INFORMATION = &CORE_MMU_INFORMATION[CORE];
...
void MMU_ENABLE(unsigned int *PTR_FLTRANSLATIONTABLE0, unsigned int *PTR_FLTRANSLATIONTABLE1, unsigned int UINT_CONTEXTID) {
	...
	// TTBR1 covers only addresses 0x40000000 - 0xFFFFFFFF
	CP15TtbCtlConfig(0x2);

	// Sets TTBR0
	CP15Ttbr0Set((unsigned int) PTR_FLTRANSLATIONTABLE0 | 0x0000005B);

	// Sets TTBR1
	CP15Ttbr1Set((unsigned int) PTR_FLTRANSLATIONTABLE1 | 0x0000005B);
