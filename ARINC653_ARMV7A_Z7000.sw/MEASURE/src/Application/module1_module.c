...
// SNIPPET_START MODULE1_MODULE_DESCRIPTION
// SNIPPET_END
// -------------------- MODULE DESCRIPTION END --------------------

// SNIPPET_START MODULE1_MODULE_INCLUDES
// SNIPPET_END

// Core #0 entry point
void (*ENTRYPOINT_CORE0)(void) = MODULE1_MODULE_DEFAULTPARTITION;

// Core #0 module configuration
MODULE_CONFIGURATION_TYPE *MODULE_CONFIGURATION_CORE0 = &MODULE1_MODULE_CONFIGURATION;
...
// SNIPPET_START MODULE1_MODULE_GLOBAL_DEFINITIONS
// SNIPPET_END

// SNIPPET_START MODULE1_MODULE_GLOBAL_VARIABLES
// SNIPPET_END

// SNIPPET_START MODULE1_MODULE_FUNCTIONS
// SNIPPET_END

// MODULE1 module default partition
void MODULE1_MODULE_DEFAULTPARTITION(void) {
	RETURN_CODE_TYPE RETURN_CODE;
	// SNIPPET_START MODULE1_MODULE_DEFAULTPARTITION_VARIABLES
	// SNIPPET_END
	...
	// SNIPPET_START MODULE1_MODULE_DEFAULTPARTITION_INITIALIZATION
	// SNIPPET_END
	...
	// SNIPPET_START MODULE1_MODULE_IDLEPARTITION_INITIALIZATION
	// SNIPPET_END

	// Main loop
	while (true) {

		// SNIPPET_START MODULE1_MODULE_IDLEPARTITION_CODE
		// Sets LEDs pattern
		TEST_LED1_OFF();
		// SNIPPET_END
	}
